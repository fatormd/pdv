...
// --- Renderização das mesas abertas ---
...
// --- Função ÚNICA de busca de produtos --- (garantia: só existe 1 no arquivo!)
...
// ... Demais funções de manipulação de dados, como openTable, removeSentItem, transferSentItem, addItemToOrder, updateItemQuantity, sendOrderToProduction, etc., conforme já estavam funcionando no seu código ...
...
function initializeListeners() {
    document.body.addEventListener('click', (e) => {
        ...
        // Botão de resumo da mesa (exemplo: ajuste para seu id real)
        const resumoBtn = e.target.closest('#toggleReviewBtn');
        if (resumoBtn) {
            currentMode = (currentMode === 1) ? 2 : 1;
            renderOrderScreen();
            return;
        }
        // Resto dos event listeners para outros botões...
        // ...
    });
